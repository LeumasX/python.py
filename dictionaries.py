_dictionaries ={'name':"samuel",'Age':"almost 14",'Class':"ss1",'Religion':"christian",'Job':{'Enginer':"Microsoft",'Developer':"Andriod"}}
print(_dictionaries.pop('name'))
print(_dictionaries.pop('Age'))
print(_dictionaries.pop('Class')) 
print(_dictionaries.pop('Religion'))
